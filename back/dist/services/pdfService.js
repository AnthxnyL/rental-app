...
exports.drawReceiptContent = void 0;
const date_1 = require("../utils/date");
const drawReceiptContent = (doc, tenant, month, year) => {
    const monthName = (0, date_1.getMonthName)(month);
    const lastDay = (0, date_1.getLastDayOfMonth)(month, year);
    const formattedMonth = (0, date_1.formatTwoDigits)(month);
...
exports.drawReceiptContent = drawReceiptContent;
